                ...
                */
                ...
                plot.addEventListener("mousedown", e => {
                    ...
                    if ((e.button == 1)||(e.button==0))  {
                        ...
                        // let left0 = e.screenX;
                        // let top0 = e.screenY;
                        console.log('screen left0, top0', left0, top0);
                        console.log(
                            'plot values left0 true/false, top0 true/false', 
                        ...
                        function onmove(e) {
                            ...
                            */
                            ...
                            let dy = u.posToVal(top1, 'y') - 
                                     u.posToVal(top0, 'y');
                            let ratio = u.posToVal(top1, 'y', false) 
                                        / u.posToVal(top0, 'y', false);
                            if (u.scales.y.distr==3) {
                                console.log('ratio top1/top0', ratio);
                            }
                            ...
                            if ((u.scales.y.min < 0) && (logy==3))
                              u.scales.y.min = 0.01;
                            if (logy==3) {
                                newscYMin0 = scYMin0 / ratio;
                                newscYMax0 = scYMax0 / ratio;
                                /* commented out 7/7/2023... trying a new way to calculate newscYMin0 and newscYMax0
                    ...
                    */
                    ...
                    if (logy==3) {
                        if (e.deltaY < 0) {
                            ...
                            factor_y = e.deltaX < 0 ? factor_y : 1/factor_y;
                        }
                        nyMin = u.scales.y.min / factor_y;
                        nyMax = u.scales.y.max * factor_y;
                         
                        /*  comment out 7/7/23... try a new way to scale by adjusting yMin and yMax directly for logscale
